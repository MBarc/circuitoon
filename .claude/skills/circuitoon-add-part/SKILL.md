...
7. **Look at it.** `npm run build`, then
   `node .claude/skills/circuitoon-add-part/scripts/shoot-parts.mjs <id> [more ids] --out <scratchpad dir> [--panel] [--rotate 90] [--dark]`
