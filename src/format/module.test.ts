...
describe('usesInsideLabels', () => {
  ...
  it('is set only on the header and pad parts (boards, DIP chips, display, storage, power and sensor modules, multi-lead LEDs, terminal adapter, USB panel-mount cables), never on any other built-in module', () => {
